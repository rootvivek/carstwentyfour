    ...
    <>          
     <App/>
      <div className={styles.content}>
        ...
        <h5 className="para">Here you should find everything you need regarding LEGO design system and branding guidelines.</h5>
        ...
        <p className="para-2"><b>Assets</b> is an excellent collection of each of the different types of asset we have prepared, which are great to use in content and publications.</p>
